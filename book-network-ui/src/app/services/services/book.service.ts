...
import { approvedReturnBorrowedBook } from '../fn/book/approved-return-borrowed-book';
import { ApprovedReturnBorrowedBook$Params } from '../fn/book/approved-return-borrowed-book';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `approvedReturnBorrowedBook()` */
  static readonly ApprovedReturnBorrowedBookPath = '/books/borrow/return/approved/{book-id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `approvedReturnBorrowedBook()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvedReturnBorrowedBook$Response(params: ApprovedReturnBorrowedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approvedReturnBorrowedBook(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `approvedReturnBorrowedBook$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  approvedReturnBorrowedBook(params: ApprovedReturnBorrowedBook$Params, context?: HttpContext): Observable<number> {
    return this.approvedReturnBorrowedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
